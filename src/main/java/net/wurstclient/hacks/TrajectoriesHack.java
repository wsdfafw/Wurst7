...
public final class TrajectoriesHack extends Hack implements RenderListener
{
	...
	public void onRender(float partialTicks)
	{
		...
		switch(trajectory.type())
		{
			...
			throw new IllegalStateException(
				"Unexpected value: " + trajectory.type());
		}
	...
	private void drawLine(ArrayList<Vec3d> path, ColorSetting color)
	{
	...
	private void drawEndOfLine(Vec3d end, ColorSetting color)
	{
		Vec3d camPos = RenderUtils.getCameraPos();
	...
	{
		private final ArrayList<Vec3d> path;
		private final HitResult.Type type;
		
		public Trajectory(ArrayList<Vec3d> path, HitResult.Type type)
		{
			this.path = path;
			this.type = type;
		}
		
		public ArrayList<Vec3d> path()
		{
			return path;
		}
	...
	{
		Arm mainArm = MC.options.mainArm;
