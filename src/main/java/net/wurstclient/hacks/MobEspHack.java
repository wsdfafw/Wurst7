	...
	CameraTransformViewBobbingListener, RenderListener
{
    ...
    private final EnumSetting<BoxSize> boxSize = new EnumSetting("框框大小", "§l精确§r 模式显示更加精确的\n可打击的框给每个生物.\n§l更好§r 模式会看起来框很大\n但看起来会更舒服点.", (Enum[])BoxSize.values(), (Enum)BoxSize.FANCY);
    private final CheckboxSetting filterInvisible = new CheckboxSetting("排除隐身", "不会显示隐身的生物.", false);
