...
{
	private final SliderSetting range = new SliderSetting("范围", 5, 1, 10, 0.05, ValueDisplay.DECIMAL);
	...
	public final SliderSetting fov = new SliderSetting("FOV", 360, 30, 360, 10, ValueDisplay.DEGREES);
