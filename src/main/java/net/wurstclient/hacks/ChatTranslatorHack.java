...
{
	private final EnumSetting<FromLanguage> langFrom = new EnumSetting<>("讲语言",
		FromLanguage.values(), FromLanguage.AUTO_DETECT);
	
	private final EnumSetting<ToLanguage> langTo =
		new EnumSetting<>("翻译成", ToLanguage.values(), ToLanguage.ENGLISH);
