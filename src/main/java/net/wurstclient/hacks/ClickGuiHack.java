...
public final class ClickGuiHack extends Hack
{
	...
	private final SliderSetting opacity = new SliderSetting("不透明性", 0.5, 0.15,
		0.85, 0.01, ValueDisplay.PERCENTAGE);
	
	private final SliderSetting ttOpacity = new SliderSetting("工具提示的不透明度", 0.75,
		0.15, 1, 0.01, ValueDisplay.PERCENTAGE);
	
	private final SliderSetting maxHeight = new SliderSetting("最大高度",
		"最大窗口高度 0 = 无限制", 200, 0, 1000, 50, ValueDisplay.INTEGER);
