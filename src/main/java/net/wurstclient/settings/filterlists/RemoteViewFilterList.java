...
public final class RemoteViewFilterList extends EntityFilterList
{
	...
	public static RemoteViewFilterList create()
	{
		...
		builder.add(new FilterPlayersSetting("不会查看其他玩家.", false));
		
		builder.add(new FilterSleepingSetting("不会查看正在睡觉的玩家.", false));
		...
		builder.add(new FilterArmorStandsSetting("不会查看盔甲架.", true));
