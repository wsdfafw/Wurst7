...
import net.wurstclient.clickgui.ThemeComboBoxPopup;
import net.wurstclient.settings.ThemeSetting;
import net.wurstclient.util.RenderUtils;

public final class ThemeComboBoxComponent extends Component
{
	...
	private ThemeComboBoxPopup popup;
	
	public ThemeComboBoxComponent(ThemeSetting setting)
	{
		this.setting = setting;
		popupWidth = 50; // Fixed width for theme names
	...
	private void handleLeftClick()
	{
		...
		popup = new ThemeComboBoxPopup(this, setting, popupWidth);
		GUI.addPopup(popup);
	}
	...
	private void handleRightClick()
	{
		...
		setting.setCurrentTheme(setting.getDefaultTheme());
	}
		...
		float partialTicks)
	{
		...
		String value = setting.getCurrentTheme().getName();
